...
const CasteDetailSlide = ({ navigation }) => {
  ...
  useEffect(() => {
    const storedActiveTab = sessionStorage.getItem('casteDetailActiveTab')
    if (storedActiveTab) {
      setActiveTab(storedActiveTab)
      sessionStorage.removeItem('casteDetailActiveTab')
    }
  }, [])
  ...
  const handleFamilyNavigation = (voter) => {
    ...
    sessionStorage.setItem('casteDetailActiveTab', activeTab)
  ...
  return (
    ...
    >
      <div className="sticky top-0 z-20">
        <PageHeader
          title={categoryData.casteName || 'विवरण'}
          onBack={handleBack}
