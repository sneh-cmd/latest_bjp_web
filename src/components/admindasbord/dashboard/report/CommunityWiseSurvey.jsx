  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-20 w-full px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 flex items-center justify-between shadow-md" style={{ backgroundColor: '#102463' }}>
        ...
        <h1 className="text-white text-base sm:text-lg md:text-xl font-bold text-center flex-1 px-2">समुदाय अनुसार सर्वे</h1>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button 
                    ...
                    onClick={(e) => {
                      ...
                      console.log('Call action for:', item.communityName)
                    }}
                    title="Call"
                  >
