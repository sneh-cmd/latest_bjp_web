...
const BuildingHeadDetailSlide = ({ navigation }) => {
  ...
  useEffect(() => {
    const storedActiveTab = sessionStorage.getItem('buildingHeadActiveTab')
    if (storedActiveTab) {
      setActiveTab(storedActiveTab)
      sessionStorage.removeItem('buildingHeadActiveTab')
    }
  }, [])
  ...
  const handleFamilyNavigation = (voter) => {
    ...
    sessionStorage.setItem('buildingHeadActiveTab', activeTab)
  ...
  return (
    ...
    >
      <PageHeader
        title={categoryData.name || 'बिल्डिंग प्रमुख'}
        onBack={handleBack}
