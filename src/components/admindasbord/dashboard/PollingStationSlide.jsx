        ...
        {showSearch && (
          <div className="px-4 py-3 bg-white border-b border-gray-200">
            <div className="flex items-center bg-gray-100 rounded-lg px-3 py-2">
              ...
              <input
                type="text"
                placeholder="Search polling stations... मतदान स्थल खोजें..."
                value={searchQuery}
            ...
            {searchQuery && (
              <div className="mt-2 text-xs text-gray-600">
                Found {pollingStations.length} station{pollingStations.length !== 1 ? 's' : ''}
              </div>
            )}
          </div>
        )}
                    ...
                    <div className="flex-1 pt-1 flex items-center justify-between">
                      ...
                      <button className="ml-2 flex-shrink-0">
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M17 9c0-2.76-2.24-5-5-5s-5 2.24-5 5c0 5.25 5 13 5 13s5-7.75 5-13z" fill="#4285F4"/>
                          <circle cx="12" cy="9" r="2.5" fill="#FBBC04"/>
                          <path d="M12 9a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" fill="#EA4335"/>
                        </svg>
                      </button>
                    </div>
                  </div>
