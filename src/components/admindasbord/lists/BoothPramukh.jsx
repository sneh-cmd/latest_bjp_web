    ...
    try {
      ...
      const excelData = filteredData.map((booth, index) => {
        ...
        return {
          ...
          'Total Booth Pramukh': booth.heads || 0,
          'Status': booth.assigned ? 'Assigned' : '',
          'Booth Pramukh Name': headNames.length ? headNames.join(', ') : '',
          'Mobile Phone': headPhones.length ? headPhones.join(', ') : sanitizeHeadField(booth.phoneNumber)
        }
      })
