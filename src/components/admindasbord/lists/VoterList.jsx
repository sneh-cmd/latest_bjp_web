...
const VoterList = ({ navigation }) => {
  ...
  return (
    <div 
      ...
      className={`min-h-screen bg-white transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
    >
      {/* Header - Dark Blue Background */}
      <div className="px-3 py-2 flex-shrink-0 shadow-md" style={{backgroundColor: '#103a94'}}>
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-white text-base font-semibold">बूथ नं -{currentBoothNum}</h1>
          
          {/* Search Icon */}
          <button className="w-6 h-6 flex items-center justify-center hover:bg-white/10 rounded-lg transition-colors">
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 overflow-y-auto px-2 py-2 custom-scrollbar" style={{
        maxHeight: 'calc(100vh - 100px)' // Account for compact header and footer
      }}>
      ...
      <div className="px-3 py-2 flex-shrink-0 shadow-md" style={{backgroundColor: '#103a94'}}>
        <div className="flex items-center justify-center">
          <div className="bg-white rounded-lg px-4 py-1">
            <span className="text-sm font-semibold" style={{color: '#103a94'}}>
