...
const CallSurveyUserDetailModal = ({ 
  ...
  const handleWhatsApp = (userData) => {
    // Get phone number from various possible fields
    const phoneNumber = userData.phoneNumber || userData.phone || userData.mobile_no || userData.mobile
    ...
    if (cleanedNumber.startsWith('91')) {
      ...
      const actualNumber = cleanedNumber.substring(2)
