...
import { date_wise_slip_sending_voter } from '../../../../apidata.jsx'
...
const DateWiseSlipVoterList = ({ navigation }) => {
  ...
  const fetchVoters = useCallback(async () => {
    ...
    try {
      ...
      const response = await date_wise_slip_sending_voter(selectedDate, panelApiUrl)
      ...
      console.error('Error fetching date-wise slip voters:', err)
  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-hidden" style={{ backgroundColor: '#e5e8ff' }}>
      <PageHeader
        title={selectedDate || 'तारीख अनुसार स्लिप प्राप्तकर्ता'}
        onBack={handleBack}
...
export default DateWiseSlipVoterList
